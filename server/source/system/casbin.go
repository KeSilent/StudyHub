...
func (i *initCasbin) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []adapter.CasbinRule{
		...
		{Ptype: "p", V0: "888", V1: "/eduClassSession/createEduClassSession", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/eduClassSession/deleteEduClassSession", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/eduClassSession/deleteEduClassSessionByIds", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/eduClassSession/updateEduClassSession", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/eduClassSession/findEduClassSession", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/eduClassSession/getEduClassSessionList", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/eduCourse/createEduCourse", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/eduCourse/deleteEduCourse", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/eduCourse/deleteEduCourseByIds", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/eduCourse/updateEduCourse", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/eduCourse/findEduCourse", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/eduCourse/getEduCourseList", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/eduOrganization/getEduOrganizationList", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/eduOrganization/createEduOrganization", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/eduOrganization/deleteEduOrganization", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/eduOrganization/deleteEduOrganizationByIds", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/eduOrganization/updateEduOrganization", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/eduEnrollment/createEduEnrollment", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/eduEnrollment/deleteEduEnrollment", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/eduEnrollment/deleteEduEnrollmentByIds", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/eduEnrollment/updateEduEnrollment", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/eduEnrollment/findEduEnrollment", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/eduEnrollment/getEduEnrollmentList", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/base/wxlogin", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/base/getOrganizationList", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/user/getUserListByRoleIdAndOrgId", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/user/student_register", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/eduEnrollment/updateCourseId", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/eduEnrollment/consumptionClass", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/eduEnrollment/addSession", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/user/getUserInfoById", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/eduClassSession/getEduClassSessionListByUser", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/eduClassSession/getStudentsWithLessThanFiveSessions", V2: "GET"},
