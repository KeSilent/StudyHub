...
func Routers() *gin.Engine {
	...
	}
	{
		...
		edu_organizationRouter.InitEduCourseRouter(PrivateGroup)

		edu_organizationRouter.InitEduOrganizationRouter(PrivateGroup)
	}
