...
import (
	...
	"errors"
	"fmt"
	ast2 "github.com/KeSilent/study-hub/server/utils/ast"
	"io"
	"mime/multipart"
	"os"
	"path/filepath"
	...
	"github.com/KeSilent/study-hub/server/resource/autocode_template/subcontract"
...
func Init(Package string) {
	...
	packageInjectionMap = map[string]astInjectionMeta{
		packageServiceName: {
			...
			importCodeF:  "github.com/KeSilent/study-hub/server/%s/%s",
			packageNameF: "%s",
